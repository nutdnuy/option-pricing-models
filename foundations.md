...
\end{equation}$$ โดย $\mathcal{T}_{[t,T]}$ คือเซตของเวลาหยุดที่รับค่าในช่วง $[t,T]$. โครงสร้างที่เหลือของบทความจัดเรียงตามพัฒนาการทางประวัติศาสตร์ของแบบจำลอง เริ่มจากแบบจำลองบาเชอลิเยในหัวข้อ 2 ผู้อ่านที่ต้องการภูมิหลังเชิงปฏิบัติเพิ่มเติมสามารถศึกษาได้จาก (Hull 2018).
...
**Assumption 2** (พลวัตแบบ ABM). ภายใต้มาตรวัดเชิงกลาง-ความเสี่ยง ราคาสินทรัพย์ (หรือราคาฟอร์เวิร์ด $F_t$) เป็นไปตามสมการเชิงอนุพันธ์สโทแคสติก (Stochastic Differential Equation, SDE) $$\begin{equation}
\label{eq:abm-sde}
