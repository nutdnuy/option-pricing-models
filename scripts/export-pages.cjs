...
for (const name of ['assets', 'downloads', 'style.css', 'book.css', 'app.js',
  'app.js.LEGAL.txt', 'site.js', 'search-index.js', 'THIRD_PARTY_NOTICES.md']) {
  if (fs.existsSync(path.join(root, name))) copy(name);
}
